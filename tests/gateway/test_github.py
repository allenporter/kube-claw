...
async def test_github_adapter_poll_new_comment():
    ...
    with patch("asyncio.create_subprocess_exec") as mock_exec:
        ...
        mock_process_view.communicate.return_value = (json.dumps(mock_comments).encode(), b"")
        mock_process_view.return_code = 0 # Wait, it's returncode in subprocess but return_code in some mocks?
